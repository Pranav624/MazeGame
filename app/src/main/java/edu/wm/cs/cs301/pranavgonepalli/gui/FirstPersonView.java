...
import edu.wm.cs.cs301.pranavgonepalli.generation.BSPBranch;
import edu.wm.cs.cs301.pranavgonepalli.generation.BSPLeaf;
import edu.wm.cs.cs301.pranavgonepalli.generation.BSPNode;
import edu.wm.cs.cs301.pranavgonepalli.generation.Floorplan;
import edu.wm.cs.cs301.pranavgonepalli.generation.Wall;
...
public class FirstPersonView {
	...
	private boolean drawPolygons(int x1, int x2, int y11, int y12, int y21, int y22) {
		...
		while (x1i <= x2) {
			...
			myPanel.addFilledPolygon(xps, yps, 4);
